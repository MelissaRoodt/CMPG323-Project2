...
using Ecopower_project2_33509735.Models;
using Microsoft.AspNetCore.Authorization;

namespace Ecopower_project2_33509735.Controllers
{
    [Authorize]
    [ApiController]
    ...
    {
        private readonly ecopower_dbContext _context;

        public OrderDetailsController(ecopower_dbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'ecopower_dbContext.OrderDetails'  is null.");
          }
