...
using System.Linq;
using Ecopower_project2_33509735.Authentication;
...
builder.Services.AddDbContext<ecopower_dbContext>(options => options.UseSqlServer("name=ConnectionStrings:DefaultConnection"));
